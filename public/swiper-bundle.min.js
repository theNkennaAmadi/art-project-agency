        ...
        pe({
            ...
            setTranslate: () => {
                ...
                for (let e = 0; e < a.length; e += 1) {
                    ...
                    const w = `rotateX(${(p?0:-n)+0.01}deg) rotateY(${(p?n:0)+0.01}deg) translate3d(${f}px, ${g}px, ${v}px)`;
                ...
                if (s.style.transformOrigin = `50% 50% -${o/2}px`, s.style["-webkit-transform-origin"] = `50% 50% -${o/2}px`, c.shadow)
                    if (p) m.style.transform = `translate3d(0px, ${r/2+c.shadowOffset}px, ${-r/2}px) rotateX(90.01deg) rotateZ(0deg) scale(${c.shadowScale})`;
                    else {
                        const e = Math.abs(h) - 90 * Math.floor(Math.abs(h) / 90),
                            ...
                            a = c.shadowScale / t,
                            i = c.shadowOffset;
                        m.style.transform = `scale3d(${s}, 1, ${a}) translate3d(0px, ${n/2+i}px, ${-n/2/a}px) rotateX(-90.01deg)`
                    } const f = (d.isSafari || d.isWebView) && d.needPerspectiveFix ? -o / 2 : 0;
                s.style.transform = `translate3d(0px,0,${f}px) rotateX(${(t.isHorizontal()?0:h)+0.01}deg) rotateY(${(t.isHorizontal()?-h:0)+0.01}deg)`, s.style.setProperty("--swiper-cube-translate-z", `${f}px`)
            },
            setTransition: e => {
                const {
                    el: s,
        ...
        pe({
            ...
            setTranslate: () => {
                ...
                for (let r = 0; r < e.length; r += 1) {
                    ...
                    const m = `translate3d(${p}px, ${u}px, 0px) rotateX(${c+0.01}deg) rotateY(${d+0.01}deg)`;
        ...
        s({
            ...
            setTranslate: () => {
                ...
                for (let e = 0, s = a.length; e < s; e += 1) {
                    ...
                    const y = `translate3d(${w}px,${v}px,${f}px)  rotateX(${h+0.01}deg) rotateY(${m+0.01}deg) scale(${b})`;
        ...
        pe({
            ...
            setTranslate: () => {
                ...
                for (let s = 0; s < e.length; s += 1) {
                    ...
                    const g = u.join(", "),
                        v = `rotateX(${m[0]+0.01}deg) rotateY(${m[1]+0.01}deg) rotateZ(${m[2]}deg)`,
